...
t
    ...
    def write_vars(self, i: instr) -> Set[location]:
        ...
        match i:
            ...
            # callq
            #case Callq('read_int', i_parameter):  # write into e_reg_caller_saved function registers
            case Callq(command, i_parameter):  # write into e_reg_caller_saved function registers
                    for register in e_reg_callee_saved:
