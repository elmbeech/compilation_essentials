...
import compiler
#import functions
import interp_Lfun, interp_Cfun  # interp_Lvar, interp_Lif, interp_Cif, interp_Lwhile, interp_Ltup, interp_Ctup, interp_Lfun, interp_Cfun
import type_check_Lfun, type_check_Cfun # type_check_Lvar, type_check_Lif, type_check_Cif, type_check_Lwhile, type_check_Cwhile, type_check_Ltup, type_check_Ctup, interp_Lfun, interp_Cfun
